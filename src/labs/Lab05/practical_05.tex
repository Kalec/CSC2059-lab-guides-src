...
\subsection{A.1 Run the demonstration}
...
\subsection{A.2 Inspect the existing implementation}
...
\subsection{A.3 Implement \texttt{insertDouble()}}
...
\subsection{A.4 Optional extension: implement \texttt{insertPerson()}}
...
\subsection{A.5 Reflect on the duplication}
...
\subsection{B.1 Run the demonstration}
...
\subsection{B.2 Inspect the generic insertion function}
...
\subsection{B.3 Use the tests to guide your implementation}
...
\subsection{B.4 Run the demonstration again}
...
\subsection{B.5 From duplication to refactoring}
...
\subsection{C.1 Observe the demonstration}
...
\subsection{C.2 Generalising an entire container}
...
\subsection{C.3 A short detour: exceptions in C++}
...
\subsection{C.4 Implement the indexing operator}
...
\subsection{C.5 Verify your implementation}
...
\subsection{C.6 Abstraction in Action}
...
\subsection{D.1 Observe the demonstration}
...
\subsection{D.2 Inspect the Stack interface}
...
\subsection{D.3 Implement equality}
...
\subsection{D.4 Implement searching}
...
\subsection{D.5 Implement printing}
...
\subsection{D.6 Verify your implementation}
...
\subsection{D.7 The Abstraction Journey}
