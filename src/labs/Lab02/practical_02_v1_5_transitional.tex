...
\section{Recommended Future Figures}

\begin{tipbox}
This transitional version contains no figures, matching the current source document. If figures are added later, the most useful additions would be:

\begin{itemize}
  \item a workflow cycle diagram after the Workflow Reminder;
  \item a repository tree diagram in the Repository Tour;
  \item a header/source relationship diagram showing how \texttt{myFunctions.h}, \texttt{myFunctions.cpp}, \texttt{main.cpp}, and \texttt{tests/public\_tests.cpp} relate to each other.
\end{itemize}
\end{tipbox}
