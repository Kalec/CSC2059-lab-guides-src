...
\section{Optional: Installing Git and Visual Studio Code}
\begin{infobox}
...
\subsubsection{Configure VS Code to Use Git Bash}
...
\subsubsection{Open the command palette}
...
\subsubsection{Select the Default Terminal Profile}
Type:
...
\subsubsection{Open a New Terminal}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../../../assets/figures/practical01/Config VSCode.png}
\label{fig:gitbash}
\caption{Configuring Git Bash as the default terminal in VS Code}
\end{figure}
\begin{reflectionbox}
...
Running \mintinline{text}{git --version} displays a version number.
