...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        keepaspectratio
    ]{../../../assets/figures/practical10/hash_table.png}
    \caption{Mental model of a hash table, showing how catalogue numbers are mapped to buckets and how collisions are handled using chaining.}
...
Open \texttt{Sorting.cpp} and complete the implementation of the \texttt{bubbleSortByTitle()} function and the helper \texttt{comesBefore()} function.
...
\begin{figure}[htbp]
    ...
    \caption{Mental model of Quick Sort, showing pivot selection, partitioning, and the recursive processing of smaller subproblems.}
